...
export URHO3D_HOME=/Users/${USER}/Documents/ude4/kmc_engine/build_and
../cmake_android.sh ./ -DANDROID_NATIVE_API_LEVEL=12 -DCMAKE_BUILD_TYPE=Debug -DANDROID_NDK_GDB=1
